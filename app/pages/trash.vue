...
const { data: files, refresh, pending } = useFetch('/api/files?view=trash')
...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="font-display text-2xl lg:text-3xl font-bold text-white mb-1">Trash</h1>
        <p class="text-gray-500 text-sm">Items deleted recently</p>
      </div>
