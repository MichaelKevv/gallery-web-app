...
const { data: files, refresh, pending } = useFetch('/api/files?view=recent')
...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="font-display text-2xl lg:text-3xl font-bold text-white mb-1">Recent</h1>
        <p class="text-gray-500 text-sm">Uploaded in the last 7 days</p>
      </div>
