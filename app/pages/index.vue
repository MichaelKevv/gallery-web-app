...
const { data: files, refresh, pending } = useFetch('/api/files?view=dashboard')
...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="font-display text-2xl lg:text-3xl font-bold text-white mb-1">Dashboard</h1>
        <p class="text-gray-500 text-sm">Overview of your files</p>
      </div>
